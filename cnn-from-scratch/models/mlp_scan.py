...
class CNN_SimpleScanningMLP():
    ...
    def init_weights(self, weights):
        ...
        self.conv1.conv1d_stride1.W = w1.T.reshape(8, 8, 24)
        self.conv2.conv1d_stride1.W = w2.T.reshape(16, 1, 8)  
        self.conv3.conv1d_stride1.W = w3.T.reshape(4, 1, 16)
...
class CNN_DistributedScanningMLP():
    ...
    def init_weights(self, weights):
        ...
        # w1, w2, w3 contain the weights for the three layers of the MLP
        # Load them appropriately into the CNN
        W1 = w1.T.reshape(4, 2, 8, 24)
        W2 = w2.T.reshape(2, 8, 4, 2)
        W3 = w3.T.reshape(1, 4, 2, 8)
        ...
        self.conv1.conv1d_stride1.W = W1[0, :, 0:2, :].transpose(0, 2, 1)
        self.conv2.conv1d_stride1.W = W2[0, :, 0:2, :].transpose(0, 2, 1)
        self.conv3.conv1d_stride1.W = W3[0].transpose(0, 2, 1)
